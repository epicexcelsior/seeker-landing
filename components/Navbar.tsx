          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden lg:block">
              <Link
                ...
                className="group relative px-6 py-2.5 bg-transparent border border-seeker-gold text-seeker-gold font-bold text-sm tracking-wide overflow-hidden transition-all duration-300 hover:bg-seeker-gold hover:text-black"
              >
