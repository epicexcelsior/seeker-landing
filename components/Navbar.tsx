...
export function Navbar() {
  return (
    <motion.nav 
      ...
      className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 md:px-12 md:py-6 bg-black/20 backdrop-blur-xl border-b border-white/5 supports-[backdrop-filter]:bg-black/10"
    >
